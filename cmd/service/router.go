...
func bootstrapEventRouter(cacheProvider cache.Cache, pubCB router.Callback) *router.Router {
	...
	router.RegisterLogRoute(w3.H("0x5f7542858008eeb041631f30e6109ae94b83a58e9a58261dd2c42c508850f939"), handler.HandleTokenTransferFromLog())
	...
	router.RegisterInputDataRoute("a9059cbb", handler.HandleTokenTransferInputData())
	router.RegisterInputDataRoute("23b872dd", handler.HandleTokenTransferInputData())
